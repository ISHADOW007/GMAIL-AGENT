...
def build_email_graph(
    ...
    graph.add_node(
        ...
        _wrap_node(
            "human_review",
            make_human_review_node(mailbox, memory_store),
            progress_callback,
        ),
    )
    graph.add_node(
    ...
    graph.add_node(
        "update_memory",
        _wrap_node("update_memory", make_update_memory_node(memory_store), progress_callback),
    )
    graph.add_node(
        "mark_processed",
    ...
    graph.add_edge("revise_reply", "human_review")
